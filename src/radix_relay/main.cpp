...
auto main(int argc, char **argv) -> int
{
...

  {
    ...
    auto orchestrator = std::make_shared<core::session_orchestrator<bridge_t, nostr::request_tracker>>(
    ...
    auto spawn_orchestrator_loop =
      [](const std::shared_ptr<boost::asio::io_context> &ctx,
        std::shared_ptr<core::session_orchestrator<bridge_t, nostr::request_tracker>> orch) {
        boost::asio::co_spawn(
          *ctx,
