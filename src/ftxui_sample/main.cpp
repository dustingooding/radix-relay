...
// configuration step. It creates a namespace called `radix_relay`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", radix_relay::cmake::project_name, radix_relay::cmake::project_version) };
